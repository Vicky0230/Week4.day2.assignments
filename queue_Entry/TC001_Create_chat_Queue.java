...
public class TC001_Create_chat_Queue {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			String getIncident=driver.findElement(By.id("chat_queue_entry.number")).getAttribute("value");
			System.out.println("GetIncident Number :"+getIncident);
			
			driver.findElement(By.id("sysverb_insert")).click();
			
			System.out.println("Chat Query Created");
